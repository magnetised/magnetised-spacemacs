...
before layers configuration."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(material
                         granger
                         hickey
                         ;; love solarized but in emacs the contrast for selected regions is
                         ;; too low
                         solarized-dark
                         monokai
                         )
   ...
   dotspacemacs-default-font '("Meslo LG M for Powerline"
                               ...
                               :width normal
                               :powerline-scale 1.1)
   ;; https://github.com/syl20bnr/spacemacs/blob/master/doc/DOCUMENTATION.md#powerline-separators
   ...
   ;; https://github.com/syl20bnr/spacemacs/tree/master/contrib/git#github-support
   git-enable-github-support t
   ;; https://github.com/syohex/emacs-git-gutter-fringe#position-of-fringe
...
layers configuration."
  ...
  (global-company-mode)
  ;; This turns on the helpful guide lines at the start of the line,
  ;; toggle using "SPC t i"
  (indent-guide-mode)
  ;; Don't know if this is the right place to put this, but it works
